...
3.  Logistic General Additive Model
...
plt.title('Testing curve for Logistic Regression (ROC curve)', fontsize=9)
plt.xticks(fontsize=7)
plt.yticks(fontsize=7)

plt.legend(loc='lower right')
plt.grid(True)
plt.savefig("graphs/log_reg_curve.png", dpi=300, bbox_inches="tight")
plt.show()
```
...
plt.xlabel('False Positive Rate = 1- Specificity', fontsize=8)
plt.ylabel('True Positive Rate = Sensitivity', fontsize=8)
plt.title('Testing curve for Random Forest (ROC curve)', fontsize=9)
plt.xticks(fontsize=7)
plt.yticks(fontsize=7)

plt.legend(loc='lower right')
plt.grid(True)
plt.savefig("graphs/ran_for_curve.png", dpi=300, bbox_inches="tight")
plt.show()
```
...
plt.xlabel('False Positive Rate = 1- Specificity', fontsize=8)
plt.ylabel('True Positive Rate = Sensitivity', fontsize=8)
plt.title('Testing curve for Logistic GAM (ROC curve)', fontsize=9)
plt.xticks(fontsize=7)
plt.yticks(fontsize=7)

plt.legend(loc='lower right')
plt.grid(True)
plt.savefig("graphs/gam_curve.png", dpi=300, bbox_inches="tight")
plt.show()
```
